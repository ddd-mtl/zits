...
use walkdir::WalkDir;
use crate::parser::*;
use crate::write_headers::{write_type_defs_header, write_zome_proxy_header};
...
pub fn generate_typescript_bindings(
    ...
    if !can_debug {
        write_type_defs_header(&mut state.type_defs_output, state.config.can_hc_imports);
        write_zome_proxy_header(&mut state.zome_proxy_output, &output, &zome_name, state.config.can_hc_imports);
    }
    ...
    if can_debug {
        ...
        println!("======================================");
        //println!("======================================");
        println!("TYPE DEFS FILE:");
        println!("======================================");
        println!("{}", state.type_defs_output);
        println!("======================================");
        if can_proxy {
            println!("ZomeProxy FILE:");
            println!("======================================");
